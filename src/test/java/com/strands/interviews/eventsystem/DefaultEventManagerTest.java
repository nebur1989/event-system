...
public class DefaultEventManagerTest {
	...
	public void testRegisterListenerAndPublishEvent() {
		final EventListenerMock eventListenerMock = new EventListenerMock(new Class[] { SimpleEvent.class });
	...
	public void testListenerWithoutMatchingEventClass() {
		final EventListenerMock eventListenerMock = new EventListenerMock(new Class[] { SubEvent.class });
		eventManager.registerListener("some.key", eventListenerMock);
		eventManager.publishEvent(new SimpleEvent(this));
	...
	public void testUnregisterListener() {
		final EventListenerMock eventListenerMock = new EventListenerMock(new Class[] { SimpleEvent.class });
		final EventListenerMock eventListenerMock2 = new EventListenerMock(new Class[] { SimpleEvent.class });
	...
	public void testRemoveNonexistentListener() {
		final DefaultEventManager dem = (DefaultEventManager) eventManager;
	...
	/**
	 * Attempting to listen a subclass event of the listen class
	 */
	@Test
	public void testInterviewEventSuperClassListener() {
		final EventListenerMock eventListenerMock = new EventListenerMock(new Class[] { SimpleEvent.class });
		eventManager.registerListener("some.key", eventListenerMock);
